...
export default function RequestAccess() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setBusy(true);
    // Formspree or similar — swap endpoint as needed
    try {
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 860px) {
          .page { grid-template-columns: 1fr; gap: 48px; padding: 40px 24px; }
          .left-col { order: 2; }
          .right-col { order: 1; }
        }
        ...
        .proof-text { font-size: 14px; color: var(--text-2); line-height: 1.5; }
        ...
        .stat-item { flex: 1; padding: 20px 24px; border-right: 1px solid var(--line); }
        ...
        .field select option[value=""] { color: var(--text-3); }
        ...
        .back-home-btn:hover { opacity: 0.8; }
      `}</style>
          ...
          {submitted ? (
            ...
            <div className="form-card">
              ...
              <form onSubmit={handleSubmit}>
                <div className="field-row">
                  ...
                  <div className="field">
                    ...
                    <input
                      type="email" placeholder="jane@firmname.com" required
                      value={form.email}
                ...
                <div className="field">
                  ...
                  <input
                    type="text" placeholder="Hartwell & Associates CPA" required
                    value={form.firm}
                ...
                <div className="field">
                  ...
                  <textarea
                    rows={3} placeholder="Current time tracking setup, specific questions, etc."
                    value={form.message}
              ...
              <p className="form-note">
                No spam. No sales calls unless you want one. Just a quick setup chat.
              </p>
            </div>
          )}
        </div>
