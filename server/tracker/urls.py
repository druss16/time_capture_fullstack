...
urlpatterns = [
    ...
    path("blocks/<int:block_id>/tab-context/", views.block_tab_context_view, name="block_tab_context"),
    ...
    path("settings/devices/<int:device_id>/", views.settings_device_set_active, name="settings_device_set_active"),
    ...
    path('billing/clients/billing-profiles/', views_billing.list_billing_profiles, name='list-billing-profiles'),
    ...
    path("reports/presets/",       views_reports_matrix.reports_presets,       name="reports_presets"),
